...
saved = save_semantic_cache(new.get('nodes', []), new.get('edges', []), new.get('hyperedges', []), root='.', allowed_source_files=uncached, prompt_file='C:/Users/Agung/.gemini/config/skills/graphify/references/extraction-spec.md')
